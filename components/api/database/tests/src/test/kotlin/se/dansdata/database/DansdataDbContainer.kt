...
class DansdataDbContainer private constructor() :
    JdbcDatabaseContainer<DansdataDbContainer>(
        ImageFromDockerfile("se/dansdata/database/tests/dansdata/db:test", false)
            .withDockerfile(Paths.get("").absolute().parent.resolve("Dockerfile"))
    ) {
